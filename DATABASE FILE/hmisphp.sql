...
CREATE TABLE `his_equipments` (
  ...
  `item_abb` varchar(200) DEFAULT NULL,
...
CREATE TABLE `his_rooms_beds` (
  ...
  `room_beds_number` varchar(200) DEFAULT NULL,
...
INSERT INTO `his_rooms_beds` (`room_id`, `room_bldg`, `room_bname`, `room_fname`, `room_number`, `room_beds_number`,`room_status`, `room_classification`,`room_station`,`room_fea`) VALUES
(2, '178640239', 'Building  1', 'Main', '3rd central wing', '333', '2', 'fully occupied', 'private','private 3rd central wing','Semi private'),
(3,  '178640239', 'Building  1', 'Main', '3rd central wing', '333', '2', 'fully occupied', 'private','private 3rd central wing','Semi private');
...
CREATE TABLE `his_guarantors` (
  ...
  `g_code` int(20) NOT NULL,
  `g_gid` int(20) NOT NULL,
  `g_name` varchar(200) DEFAULT NULL,
  `g_tele` int(20) DEFAULT NULL,
  `g_fax` varchar(200) DEFAULT NULL,
  `g-email` varchar(200) DEFAULT NULL,
...
(2, '156720', '0622169265', 'Nilo Velarde ', '09158101061', '', 'nilvel1999@gmail.com', 'Urgello Cebu City'),
(3, '156720', '0622169265', 'Nilo Velarde ', '09158101061', '', 'nilvel1999@gmail.com', 'Urgello Cebu City');
...
--
-- Dumping data for table `his_emergency`
--
...
(8, 'Peter', 'Velarde', '02/02/1992', '30', 'DCRI8', '60 Radford Street', '1458887854', 'InPatient', '2022-10-18 16:28:51.469431', 'Demo Test', NULL),
(9, 'Paul Velarde', 'Bischof', '01/19/1990', '32', 'ISL1E', '82 Bryan Street', '7412225698', 'InPatient', '2022-10-18 16:53:26.210951', 'Demo Test', NULL),
(10, 'Alen', 'Panambitan', '10/11/2000', '22', '3Z14K', '9 Hill Haven Drive', '1478885458', 'InPatient', '2022-10-18 16:54:53.104490', 'Demo Test', NULL),
(11, 'Jimuel ', 'Destura', '01/01/1980', '42', 'KU8W4', '28 Holly Street', '1458889655', 'OutPatient', '2022-10-20 17:26:45.256878', 'Test Test', NULL),
(12, 'Ira Pongasi', 'Moore', '11/06/1994', '28', '4TLG0', '117 Bleecker Street', '7412569698', 'InPatient', '2022-10-22 10:38:30.937516', 'Demo Test', NULL);
...
(1, 'Vhong Hua Hospital', '2023-01-11', 'Ira Pongasi', '9KXPM', 'Success');
