...
if (isset($_POST['add_render'])) {
    ...
    // $rc = $stmt->bind_param(
    //     'sssssssssssssss',
    $query = "INSERT INTO his_ancillary (render_name,render_pat_type,render_age,render_room_number, render_req_date,render_req_doc,render_doc_number,render_payment,render_payer_name,render_by,render_case,render_trans)
    VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param(
        'ssssssssssss',
    ...
    if ($stmt) {
        ...
        header("Location: " . 'http://localhost/HIS-SWU/backend/infostaff/his_doc_ancillary.php');
    } else {
...
<body>
    ...
    <div id="wrapper">
        ...
        <form method="post" action="his_admin_render.php" id="myForm">
            ...
            $ret = "SELECT user_fname, user_lname FROM his_user WHERE user_dept = 'Infostaff' AND user_id = ?";
            ...
            if ($result->num_rows > 0) {
                ...
                $rendered_by = $row['user_fname'] . ' ' . $row['user_lname'] . '   ' . '- Infostaff'; // Concatenate first name and last name
            } else {
                $rendered_by = "No data found"; // Handle the case where there are no matching rows
            }
            ?>

            <input type="hidden" class="form-control" value="<?php echo $rendered_by ?>">
                                    ...
                                    <div class="table-responsive my-2">
                                        <table id="transactionsLineItems" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            <thead class="table-primary">
                                                ...
                                                <tr>
                                                    <th colspan="8" class="text-center my-2" style="background-color: #38414a;color: white;">Patient Name : <?php echo $patientName; ?> &nbsp; Age:<?php echo $age; ?> Years Old </th>
                                                </tr>
                                            </thead>
                                        </table>
                                        ...
                                        <div class="form-row" style="margin-left: -2px;margin: right -2px;">
                                            ...
                                            <div class="form-group margin col-md-3">
                                                ...
                                                <input type="text" readonly name="" class="form-control small-input" id="inputlg" value="Laboratory Services">
                                            </div>
                                            <div class="form-group margin col-md-3">
                                    ...
                                    <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table id="" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                                    <thead class="table-primary">
                                                        ...
                                                        <tr>
                                                            <th colspan="8" class="text-center" style="background-color: #38414a;color: white;">Transaction Information</th>
                                                        </tr>
                                                    </thead>
                                                </table>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="transactionsLineItems" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                                <thead class="table-primary">
                                                    <tr>
                                                        <th colspan="8" class="text-center" style="background-color: #38414a;color: white;">Transaction Line Items</th>
                                                    </tr>
                                                </thead>
                                            ...
                                            <button type="button" class="btn  btn-secondary my-3" style="background-color: #38414a;" data-toggle="modal" data-target="#myModal">Select From Item Master File</button>
                                            ...
                                            <div class="modal fade bd-example-modal-xl" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <div class="form-group col-md-12 my-1">
                                                                <input type="text" readonly name="" value="ACCOUNTING Item Selection " class="form-control" style="background-color: #38414a;color:white;text-align: center;">
                                                            </div>
                                                                                        ...
                                                                                        <table id="aboutme_search" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <?php while ($row = $res->fetch_object()) { ?>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <a class="badge badge-success select-item-btn" style="background-color: #38414a; color:white ;" data-id="<?php echo $row->item_code; ?>" data-category="<?php echo $row->item_category; ?>" data-desc="<?php echo $row->item_desc; ?>" data-price="<?php echo $row->item_price; ?>">
                                                ...
                                                */
                                                                                        ...
                                                                                        <tbody>
                                                                                            <?php while ($row = $res->fetch_object()) { ?>
                                                                                                <tr>
                                                                                                    <td> <a class="badge badge-success select-item-btn" style="background-color: #38414a; color:white ;" data-id="<?php echo $row->exam_code; ?>" data-desc="<?php echo $row->exam_desc; ?>" data-category="<?php echo $row->exam_category; ?>" data-price="<?php echo $row->exam_price; ?>">
                                                                                                            <i class="far fa-eye "></i> Select
                                                                                                        </a>
        ...
        */
                                                                                        ...
                                                                                        <tbody>
                                                                                            <?php while ($row = $res->fetch_object()) { ?>
                                                                                                <tr>
                                                                                                    <td> <a class="badge badge-success select-item-btn" style="background-color: #38414a; color:white ;" data-id="<?php echo $row->pro_code; ?>" data-desc="<?php echo $row->pro_desc; ?>" data-category="<?php echo $row->pro_category; ?>" data-price="<?php echo $row->pro_price; ?>">
                                                                                                            <i class="far fa-eye "></i> Select
                                                                                                        </a></td>
                                                                        ...
                                                                        <div class="table-responsive table table-sm">
                                                                            <table id="selected-items-table" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                                                                <div class="form-group col-md-12 my-1">
                                                                                    <input type="text" readonly name="" value="Selected Item(s)" class="form-control" style="background-color:#38414a;color:white;text-align: center;">
                                                                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.demo-foo-search').on('input', function() {
                ...
                currentRequest = $.ajax({
                    url: 'http://localhost/HIS-SWU/backend/infostaff/his_admin_search.php',
                    method: 'GET',
                    data: {
                        search: searchQuery,
                        tableName: tableName,
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, item) {
                            ...
                            $(`#${resultTable} tbody`).append(`
                                        <tr>
                                            <td><a class="badge badge-success select-item-btn" style="background-color: #9B59B6; color:white ;"  data-id="${code}" data-category="${category}" data-desc="${desc}" data-price="${price}"><i class="far fa-eye "></i> Select</a></td>
                                            <td>${code}</td>
                                            <td>${category}</td>
                                            <td>${desc}</td>
                                            <td>₱${price}.00</td>
