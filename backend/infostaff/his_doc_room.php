...
<body>
                        ...
                        <div class="col-15">
                            <div class="card-box">
                                ...
                                <div class="col-md-12 d-flex justify-content-start">
                                    ...
                                    <button type="button" class="btn maroon-outline-btn " data-toggle="modal" data-target="#myModal"> Add New </button>
                                                        ...
                                                        <form method="post">
                                                            <div class="form-row">
                                                                <div class="form-group col-md-5">
                                                                    ...
                                                                    <input type="text" value="Main" name="room_bname" class="form-control small-input" id="inputEmail4" readonly style="background-color: #d6d6d6;">
                                                            ...
                                                            <div class="container-fluid my-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <!-- First Table - Beds -->
                                                                        <table id="listOfBeds" class="table table-borderless table-hover mb-0 table-sm">
                                                                        ...
                                                                        <div>
                                                                            <button type="button" id="addBed" class="btn btn-secondary my-2">Add</button>
                                                                            <button type="button" id="deleteBed" class="btn btn-secondary my-2">Delete</button>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <!-- Second Table - Price -->
                                                                        <table class="table table-borderless table-hover mb-0 table-sm">
                                                                            <thead class="text-center">
                                ...
                                <form method="post" action="his_doc_room.php">
                                            ...
                                            ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="his_doc_view_room_copy.php?room_id=<?php echo $row->room_id; ?>" class="badge badge-success"><i class="far fa-eye "></i> View</a>
                                                            <a href="his_doc_update_room.php?room_id=<?php echo $row->room_id; ?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Update</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            // $("#standard_price_temp").change(function() {
            //     $("#standard_price").val($(this).val())
            // })
            // $("#roomIn_price_temp").change(function() {
            //     $("#roomIn_price").val($(this).val())
            // })
        })
    </script>
</body>
