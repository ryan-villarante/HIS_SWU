...
if (isset($_POST['update_patient'])) {
    ...
    $query = "UPDATE  his_patients  SET pat_fname=?, pat_lname=?, pat_age=?, pat_dob=?, pat_number=?, pat_phone=?, pat_type=?, pat_addr=?, pat_doc=?,  pat_series=?,  pat_case=?,  pat_case_type=? ,  pat_num=?  WHERE pat_id = ?";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('sssssssssssssi', $pat_fname, $pat_lname, $pat_age, $pat_dob, $pat_number, $pat_phone, $pat_type, $pat_addr, $pat_doc, $pat_series, $pat_case, $pat_case_type, $pat_num, $pat_id);
    $stmt->execute();
    /*
    ...
    if ($stmt) {
        ...
        header("Location: " . 'http://localhost/HIS-SWU/backend/infostaff/his_doc_outpatient.php');
    } else {
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="container-fluid ">
                                                ...
                                                <a href="his_doc_outpatient.php" button type="submit" name="update_patient" class="ladda-button btn btn-danger my-3" data-style="expand-right">Cancel</button></a>
                                                <button type="submit" name="update_patient" class="ladda-button btn btn-secondary my-3" data-style="expand-right">Update OutPatient</button>
