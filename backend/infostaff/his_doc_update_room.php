                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="his_doc_room.php">Rooms and Beds</a></li>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="inputState" value="<?php echo $row->room_bname; ?>" name="room_bname" class="form-control  small-input" readonly>
                                                    <!-- <option>Main</option>
                                            ...
                                            */
                                            ...
                                            <div class="">
                                                <a href="his_doc_room.php" button type="" name="" class="ladda-button btn btn-danger my-3" data-style="expand-right">cancel</button></a>
                                                <button type="submit" name="update_rooms" class="ladda-button btn btn-secondary my-3" data-style="expand-right">Update Room</button>
                                            </div>
