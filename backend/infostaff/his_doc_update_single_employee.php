                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="his_doc_consultant.php">Consultant</a></li>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" name="doc_fee" value="<?php echo $row->doc_fee; ?>">
                                                </div>
                                            ...
                                            <div>
                                                <a href="his_doc_consultant.php" button type="button" name="update_doc" class="ladda-button btn maroon-outline-btn my-3 " data-style="expand-right">Cancel</button></a>
                                                <button type="submit" name="update_doc" class="ladda-button btn maroon-outline-btn my-3 " data-style="expand-right">Update Consultant</button>
