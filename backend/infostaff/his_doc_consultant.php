                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card-box">
                                                        ...
                                                        <form method="post">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input required="required" type="number" class="form-control" name="doc_fee">
                                                                </div>
                                                            </div>
                                ...
                                <form method="post" action="his_doc_consultant.php">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="his_doc_update_single_employee.php?doc_number=<?php echo $row->doc_number; ?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Update</a>
