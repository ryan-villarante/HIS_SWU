                                    ...
                                    <div class="table-responsive table-sm">
                                        <table id="patient-table" class="table table-borderless table-hover mb-0" data-page-size="7">
                                            ...
                                            <tbody data-toggle="true" data-show="4">
                                                ...
                                                *
                                            */
                                                $ret = "SELECT * FROM  his_patients WHERE pat_type = 'OutPatient' AND deleted = 0 AND discharged = 0 ";
                ...
                $(document).ready(function() {
                    ...
                    $("#updateInpatient").click(function() {
                        ...
                        if ($(".inpatient_table.selected").length > 0) {
                            ...
                            location.href = `/HIS-SWU/backend/infostaff/his_doc_update_single_outpatient.php?pat_id=${pat_id}&pat_number=${pat_number}`;
                        }
                    });
