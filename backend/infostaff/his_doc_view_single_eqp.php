                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="his_doc_equipment.php">Inventory</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7">
                                            <div class="pl-xl-3 mt-3 mt-xl-0">
                                                <h2 class="mb-3">Description : <?php echo $row->item_desc; ?></h2>
                                                <hr>
                                                <h4 class="text-secondary">Code: <?php echo $row->item_code; ?></h4>
                                                <hr>
