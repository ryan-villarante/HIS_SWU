                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="his_doc_guarantor.php"> Master Files</a></li>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="inputCategory" required="required" name="g_type" class="form-control">
                                                        <option <?= $row->g_type == 'None' ? ' selected="selected"' : ''; ?>>None</option>
                                                        <option <?= $row->g_type == 'HMO' ? ' selected="selected"' : ''; ?>>HMO</option>
                                                        <option <?= $row->g_type == 'Philhealth' ? ' selected="selected"' : ''; ?>>Philhealth</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <a href="his_doc_guarantor.php" button type="button" class="ladda-button btn maroon-btn my-3 " data-style="expand-right">Cancel</button></a>
