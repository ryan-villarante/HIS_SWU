                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                               ...
                               <!-- <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_add_employee.php">Add Consultant</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_employee.php">View Consultant</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_manage_employee.php">Manage Consultant</a>
                                    </li>
                                    <hr>
                                    <li>
                                    ...
                                    <li>
                                        <a href="his_admin_transfer_employee.php">Transfer Consultant</a>
                                    </li>
                                </ul> -->
                            </li>
                           ...
                           <!-- <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_employee_records.php">Consultant Records</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_swu_indi.php">Individual Users</a>
                                    </li>

                                    <li>
                                        <a href="his_admin_swu_group.php">User Groups</a>
                                    </li>
                        ...
                        <a href="his_admin_view_patients.php">
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_swu_emergency.php">
                                        <i class="fas fa-lock"></i>
