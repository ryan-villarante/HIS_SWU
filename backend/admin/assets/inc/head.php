<head>
    ...
    <style>
        ...
        .image-container {
            ...
            /* Replace #ff0000 with your desired border color */
        ...
        #patient-table tbody tr:hover {
            ...
            cursor: pointer;
            /* Change to 'pointer' if you want the cursor to change on hover */
        }

        .inpatient_table.active {
            background-color: #bee0ff;
        }

        .inpatient_table.selected {
            background-color: #bee0ff;
        }
