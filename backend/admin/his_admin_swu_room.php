                        ...
                        <div class="col-15">
                            <div class="card-box">
                                <div class="col-md-12 d-flex justify-content-end">
                                    ...
                                    <button type="button" class="	fa fa-plus lg-2 bi-plus btn btn-success btn-lg-2 " data-toggle="modal" data-target="#myModal"> Add Room/Beds </button>
                                        ...
                                        ?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_view_room_copy.php?room_number=<?php echo $row->room_number; ?>" class="badge badge-success"><i class="far fa-eye "></i> View</a>
