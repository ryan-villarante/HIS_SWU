                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dietary Services</a></li>
                                            <li class="breadcrumb-item active">Dietary Services</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Dietary Services</h4>
                                    <div class="mb-2">
                                        <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-toggle="true">Diet Description</th>
                                                <th data-hide="phone">Diet Remarks</th>
                                                <th data-hide="phone">Age</th>
                                                <th data-hide="phone">Post Date Time</th>
                                                <th data-hide="phone">Change Diet</th>
                                                <th data-hide="phone">Allergy</th>
                                                <th data-hide="phone">Religion</th>
                                                <th data-hide="phone">Attending Physicians</th>
                                                <th data-hide="phone">Diagnosis</th>
                                                <th data-hide="phone">Nationality</th>
                                                <th data-hide="phone">Registry No.</th>
                                                <th data-hide="phone">Registry Date Time</th>
                                                <th data-hide="phone">Citizenship</th>
