                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="container-fluid ">
                                                ...
                                                <a href="his_admin_inpatient_records.php" button type="submit" name="update_patient" class="ladda-button btn maroon-outline-btn my-2" data-style="expand-right">Cancel</button></a>
                                                <button type="submit" name="update_patient" class="ladda-button btn maroon-outline-btn my-2" data-style="expand-right">Update Patient</button>
