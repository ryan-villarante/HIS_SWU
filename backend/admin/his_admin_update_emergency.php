...
if (isset($_POST['update_emergency'])) {
    ...
    $query = "UPDATE  his_patients  SET pat_fname=?, pat_lname=?, pat_age=?, pat_dob=?, pat_status=?, pat_gender=?, pat_number=?, pat_phone=?, pat_type=?, 
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="his_admin_emergency.php">Patients</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <a href="his_admin_emergency.php" button type="submit" name="update_emergency" class="ladda-button btn maroon-outline-btn my-3" data-style="expand-right">Cancel</button></a>
                                            <button type="submit" name="update_emergency" class="ladda-button btn maroon-outline-btn my-3" data-style="expand-right">Update Emergency</button>
