...
if (isset($_POST['update_emergency'])) {
    ...
    pat_addr=?  ,pat_er_case=? ,pat_er_date=? ,pat_er_series=? ,pat_er_area=? ,pat_bed=? ,pat_billed=? , pat_ailment=?,  pat_num=?  WHERE pat_id = ?";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <button type="submit" name="update_emergency" class="ladda-button btn btn-success" data-style="expand-right">Update Emergency</button>
