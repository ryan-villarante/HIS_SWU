<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_user']))
		{
		    ...
		    move_uploaded_file($_FILES["user_dpic"]["tmp_name"],"../doc/assets/images/users/".$_FILES["user_dpic"]["name"]);
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->user_dept;?>" name="user_dept" class="form-control"  id="inputPassword4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                               ...
                                               <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required"  type="file" name="user_dpic" class="btn btn-success form-control"  id="inputCity">
                                                </div>
                                            </div>       
