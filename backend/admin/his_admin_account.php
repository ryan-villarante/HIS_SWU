                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    <img src="../admin/assets/images/users/<?php echo $row->ad_dpic; ?>" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">

                                    <h4 class="mb-0"><?php echo $row->ad_fname; ?> <?php echo $row->ad_lname; ?></h4>
                                    <p class="text-muted">@System_Administrator_HIS</p>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="aboutme">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="ad_fname" class="form-control" id="firstname" value="<?php echo $row->ad_fname; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="lastname">Last Name</label>
                                                            <input type="text" name="ad_lname" class="form-control" id="lastname" value="<?php echo $row->ad_lname; ?>">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="ad_email" class="form-control" id="useremail" value="<?php echo $row->ad_email; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="useremail">Profile Picture</label>
                                                            <input type="file" name="ad_dpic" class="form-control btn btn-dark" style="background-color: #800;" id="useremail" value="<?php echo $row->ad_dpic; ?>">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="text-right">
                                                    <button type="submit" name="update_profile" class="btn btn-success waves-effect waves-light mt-2" style="background-color: #800;"><i class="mdi mdi-content-save"></i> Save</button>
                                                </div>
                                            </form>
                                        ...
                                        <div class="tab-pane" id="settings">
                                            <form method="post">
                                                ...
                                                <div class="text-right">
                                                    <button type="submit" name="update_pwd" class="btn btn-success waves-effect waves-light mt-2" style="background-color: #800;"><i class="mdi mdi-content-save"></i> Update Password</button>
                                                </div>
                                            </form>
                                        </div>
