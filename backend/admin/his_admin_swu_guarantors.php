...
if (isset($_POST['add_guarantor'])) {
    ...
    $query = "INSERT INTO his_guarantors (g_code, g_gid, g_name, g_lname, g_tele,  g_email, g_address, g_type, hmo_name) values(?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('sssssssss', $g_code, $g_gid, $g_name, $g_lname, $g_tele, $g_email, $g_address, $g_type, $hmo_name);
    $stmt->execute();
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
                            ...
                            <div class="card-box">
                                ...
                                <div class="col-15">
                                    <div class="card-box">
                                                                ...
                                                                <form method="post">
                                                                    <div class="form-row required">
                                                                        ...
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <select class="form-control" required name="g_type" id="insuranceType" placeholder=" Health Insurance ">
                                                                                <option>None</option>
                                                                                <option>HMO</option>
                                                                                <option>Philhealth</option>
                                                                            </select>
                                                                        </div>
                                                                        <div id="hmoInputField" style="display: none;" class="form-group col-md-6">
                                                                            <label class="col-form-label">HMO Name</label>
                                                                            <input type="text" required="required" class="form-control" name="hmo_name" id="hmoName" placeholder="HMO Name">
                                                                        </div>
                                                                    </div>
                                        ...
                                        <form method="post" action="his_admin_swu_guarantors.php">
                                                    ...
                                                    ?>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $row->g_type; ?> <?php echo $row->hmo_name ?></td>
                                                                <td>
            ...
            <script>
                $(document).ready(function() {
                    // Function to show/hide HMO input field based on selected value
                    function toggleHMOInput() {
                        const selectedInsurance = $("#insuranceType").val();
                        if (selectedInsurance === "HMO") {
                            $("#hmoInputField").show();
                        } else {
                            $("#hmoInputField").hide();
                        }
                    ...
                    // Bind change event to insurance type dropdown
