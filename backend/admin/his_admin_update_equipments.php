                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6" style="display: none;">
                                                    ...
                                                    <input type="text" value="<?php echo $row->item_code; ?>" name="item_code" class="form-control" id="inputEmail4">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="inputState" required="required" name="item_category" value="<?php echo $row->item_category; ?>" class="form-control">
                                                        ...
                                                        <option <?= $row->item_category == 'Tablets and Capsules' ? ' selected="selected"' : ''; ?>>Tablets and Capsules</option>
                                                        <option <?= $row->item_category == 'Ampoules and Vials' ? ' selected="selected"' : ''; ?>>Ampoules and Vials</option>
                                                        <option <?= $row->item_category == 'Syrups,Suspensions and Drops' ? ' selected="selected"' : ''; ?>>Syrups,Suspensions and Drops</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
