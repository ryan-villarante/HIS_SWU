...
if (isset($_POST['add_patient'])) {
    ...
    $query = "insert into his_patients (pat_fname, pat_lname, pat_age, pat_dob, pat_status, pat_gender, pat_number, pat_phone, pat_type, pat_addr, pat_series, pat_case, pat_case_type, pat_num, pat_doc, room_id, bed_id) 
    values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('sssssssssssssssss', $pat_fname, $pat_lname, $pat_age, $pat_dob, $pat_status, $pat_gender, $pat_number, $pat_phone, $pat_type, $pat_addr, $pat_series, $pat_case, $pat_case_type, $pat_num, $pat_doc, $room_id, $bed_id);
    $stmt->execute();
    /*
        ...
        <div class="content-page-inpatient">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-row required">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <input required="required" type="text" name="pat_lname" class="form-control small-input" id="inputPassword4" placeholder=" Last Name">

                                                                    </div>
                                                                    <div class="form-group col-md-2" style="display:none">
                                                                        <?php
                                                                        $length = 5;
                                                                        $patient_number =  "OP-" . substr(str_shuffle("0123456789"), 0, 6);
                                                                        ?>
                                                                    ...
                                                                    <div class="form-group col-md-5">
                                                                        ...
                                                                        <input type="date" required="required" name="pat_dob" class="form-control small-input" id="bday" placeholder="DD/MM/YYYY">

                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <label for="inputPassword4" class="col-form-label">Age</label>

                                                                        <input readonly required="required" type="number" name="pat_age" class="form-control small-input" id="age" placeholder="Age">

                                                                    </div>
                                                                    <div class="form-group col-md-5">
                                                                        <label for="inputCity" class="col-form-label">Civil Status</label>

                                                                        <select id="inputState" name="pat_status" class=" form-control small-input">
                                                                            <option></option>
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        ...
                                                                        <select name="pat_gender" class=" form-control small-input">
                                                                            <option></option>
                                                                            <option>Male</option>
                                                                    ...
                                                                    <div class="form-group col-md-4 ">
                                                                        ...
                                                                        <input required="required" type="text" class="form-control small-input" name="pat_addr" id="inputAddress" placeholder=" Addresss">

                                                                    </div>
                                                                    <div class="form-group col-md-4">
                                                                        <label for="inputCity" class="col-form-label">Mobile Number</label>

                                                                        <input required="required" type="text" name="pat_phone" class="form-control small-input" id="inputCity">

                                                                    </div>

                                                                    <!-- <div class="form-group col-md-4">
                                                                        <label for="inputCity" class="col-form-label">Patient Ailment</label>
                                                                        <input required="required" type="text" name="pat_ailment" class="form-control small-input" id="inputCity">
                                                                    </div> -->
                                                                    <div class="form-group col-md-4" style="display: none;">
                                                                        <label for="inputState" class="col-form-label">Patient's Type</label>
                                                                        <select id="inputState" required="required" name="pat_type" class="form-control small-input">
                                                                    ...
                                                                    <div class="form-group col-md-6" style="display:none">
                                                                        ...
                                                                        <input value="<?php echo date('Y-m-d'); ?>" type="date" name="pat_case_type" class="form-control small-input" id="inputCity">
                                                                    </div>
                            ...
                            <div class="modal" id="dischargeModal" tabindex="-1" role="dialog" aria-labelledby="dischargeModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" id="toDischarge" class="btn btn-primary">Proceed</button>
                            ...
                            <!--START TAG for Proceed DISCHARGE  MODAL -->

                            <form method="post" action="his_admin_discharged.php" id="printDischarge" enctype="multipart/form-data">


                                <div class="modal" id="proceedDischarge" tabindex="-1" role="dialog" aria-labelledby="proceedDischargeLabel">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                Discharge Summary
                                                    ...
                                                    <div class="form-group col-md-12 my-2">
                                                        ...
                                                        <div class="card-body" style="padding:0rem;">
                                                            <div class="form-row" style="margin-left: -2px;margin: right -2px;">
                                                                ...
                                                                <div class="form-group margin col-md-3">
                                                                    <span class="small-text">Physician</span>
                                                                    <input type="text" readonly name="" class="form-control small-input" id="docInput" value="">
                                                                </div>
                                                                <div class="form-group margin col-md-3">
                                                                    <span class="small-text">Date of Admission</span>
                                                                    <input type="text" readonly name="" class="form-control small-input" id="admDate" value="">
                                                                </div>
                                                                <div class="form-group margin col-md-3">
                                                                    <span class="small-text">Date of Discharge</span>
                                                                    <input type="text" readonly name="" class="form-control small-input" id="dischargeDate" value="<?php echo date('Y-m-d'); ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- <input type="text" readonly name="" value="Discharge Diagnosis" class="form-control my-3" style="background-color: #6c757d;color:white;text-align: center;"> -->
                                                        <div class="form-group required margin col-md-12 my-1">
                                                            <label class="form-group-label" for=""><strong>Disposition : </strong></label>
                                                            <select class="form-control " name="dis_diag" id="" style="border: 2px solid Gray;">
                                                                <option></option>
                                                                <option>Discharge</option>
                                                                <option>Recovered</option>
                                                                <option>Transferred</option>
                                                                <option>Unimproved</option>
                                                                <option>Home Againts Medical Advise</option>
                                                                <option>Absconded</option>
                                                                <option>Improved</option>
                                                                <option>Expired</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group margin col-md-3 my-1" style="display: none;">
                                                            <label for="">Procedures/Therapies : </label>
                                                            <textarea name="dis_procedure" id="" rows="1" cols="100"></textarea>
                                                        </div>
                                                        <div class="form-group required margin col-md-12 my-1">
                                                            <label class="form-group-label" for="">Admission Result : </label>
                                                            <select class="form-control " name="dis_complication" id="" style="border: 2px solid Gray;">
                                                                <option></option>
                                                                <option>Recovered</option>
                                                                <option>Improved</option>
                                                                <option>Unimproved/Unchanged</option>
                                                                <option>Died</option>
                                                                <option>Disease Progressed</option>
                                                                <option>Stable</option>
                                                                <option>Discharged Againts Medicak Advice</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group required margin col-md-12 my-1">
                                                            <label class="form-group-label" for=""><strong>Initial Impression : </strong></label>
                                                            <textarea class="form-control" name="dis_consultation" id="" rows="4" cols="100" style="border: 1px solid gray;"></textarea>
                                                        </div>
                                                        <div class="form-group margin col-md-3   my-1">
                                                            <label for="" class="mr-2"><strong>Patient Status:</strong></label>
                                                            <input type="text" class="form-control" name="dis_lab" value="Regular Patient" readonly>
                                                        </div>

                                                        <div class="form-group required margin col-md-3 my-1">
                                                            <label class="form-group-label" for="">Discharge Diagnosis : </label>
                                                            <textarea name="dis_condition" id="" rows="3" cols="100" style="border: 1px solid gray;"></textarea>
                                                        </div>
                                                        <div style="display: none;">
                                                            <input type="text" name="dis_name" id="dis_name" />
                                                            <input type="text" name="dis_doc" id="dis_doc" />
                                                            <input type="text" name="dis_time" id="dis_time" />
                                                        </div>
                                                        <div style="display: none">
                                                            <input type="text" id="redirectToPrint" name="redirect_to_print" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <!-- <a href="his_admin_print_discharge.php" class="btn btn-primary" role="button" id="printDischargeSlip">Print</a> -->
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- END TAG for Proceed DISCHARGE  MODAL-->
                            ...
                            <div class="row-inpatient">
                                <div class="col-lg-9 my-1">
                                    ...
                                    <div class="table-responsive table-sm">
                                        <table id="patient-table" class="table table-borderless table-hover mb-0" data-page-size="10">
                                            <thead class="table-danger">
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody data-toggle="true" data-show="4">
                                                ...
                                                *
                                            */
                                                $ret = "SELECT * FROM  his_patients WHERE pat_type = 'OutPatient' AND deleted = 0 AND discharged = 0 "; //AND discharged = 0
                                                ...
                                                $cnt = 1;
                                                while ($row = $res->fetch_object()) {
                                                    // Determine the CSS class and color based on "tagged_as_mgh"
                                                    $rowClass = ($row->tagged_as_mgh == 1 && $row->discharged == 0) ? 'tagged-as-mgh-yes' : 'tagged-as-mgh-no';
                                                    $rowColor = ($row->tagged_as_mgh == 1 && $row->discharged == 0) ? '#fbffac' : '#b7eea4';

                                                    // Output the row with the added class
                                                ?>
                                                    <tr class="inpatient_table <?php echo $rowClass; ?>" data-id="<?php echo $row->pat_id; ?>" data-pat_number="<?php echo $row->pat_number; ?>" data-pat_name="<?php echo $row->pat_fname . " " . $row->pat_lname; ?>" data-pat_doc="<?php echo $row->pat_doc ?>" data-pat_date_joined="<?php echo date('Y-m-d', strtotime($row->pat_date_joined)); ?>" style="cursor:pointer;">
                                                        <td style="background-color: <?php echo $rowColor; ?>"><?php echo $cnt; ?></td>
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            /* 
                                                     ...
                                                     */
                                            $result = "SELECT count(*) FROM his_patients WHERE tagged_as_mgh =0 AND pat_type = 'OutPatient' AND discharged = 0";
                                            ...
                                            /* 
                                                     * code for summing up number of pharmaceuticals,
                                                     */
                                            $result = "SELECT count(*) FROM his_patients WHERE tagged_as_mgh =1 AND pat_type = 'OutPatient' AND discharged = 0";
                                            $stmt = $mysqli->prepare($result);
                                            $stmt->execute();
                                            $stmt->bind_result($mgh);
                                            $stmt->fetch();
                                            $stmt->close();
                                            ?>
                                            <!-- <h3 class="text-secondary mt-1"><span data-plugin="counterup" style="font-size: x-large;font-weight: bold;"></span></h3> -->
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column justify-content-end my-3">
                                        <button type="button" class="btn btn maroon-outline-btn-tag btn-xs ml-1">Summaries</button>
                                        <div class="input-group mb-1 ">
                                            <span class="input-group-text sum my-1"></span>
                                            <input type="text" name="" class="form-control summary my-1" id="inputlg" value="Active" readonly><input type="text" class="form-control summaries my-1" readonly value="<?php echo $active; ?>">
                                        </div>
                                        <div class="input-group mb-1 ">
                                            <span class="input-group-text sum2 "></span>
                                            <input type="text" name="" class="form-control summary " id="inputlg" value="MGH" readonly><input type="text" class="form-control summaries " readonly value="<?php echo $mgh; ?>">
                                        </div>
                                    </div>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    var pat_number = null;
                    var pat_doc = null;
                    var pat_date_joined = null;
                    var department_selected = null;
                    var to_notify = []

                    $("#proceed_discharge").click(function() {
                        $("#redirectToPrint").val("for_preview_print")

                        $("#printDischarge").submit()
                    })
                    ...
                    // Add a click event listener to the "Proceed" button in the dischargeModal
                    $("#toDischarge").click(function() {
                        // Retrieve data from the clicked row
                        var pat_name = $(".inpatient_table.selected").data("pat_name");
                        var pat_doc = $(".inpatient_table.selected").data("pat_doc");
                        var adm_date = $(".inpatient_table.selected").data("pat_date_joined");
                        // var discharge_date = $(".inpatient_table.selected").data("discharge_date"); // Replace this with the actual data attribute for discharge date

                        // Log the retrieved data to the console for debugging
                        // console.log("Patient Name: ", pat_name);
                        // console.log("Physician: ", pat_doc);
                        // console.log("Admission Date: ", adm_date);
                        // console.log("Discharge Date: ", discharge_date);

                        // Set values in the printDischarge modal based on the retrieved data
                        $("#patientNameInput").val(pat_name);
                        $("#dis_name").val(pat_name);
                        $("#docInput").val(pat_doc);
                        $("#dis_doc").val(pat_doc);
                        $("#admDate").val(adm_date);
                        $("#dis_time").val(adm_date);
                        // $("#dischargeDate").val(discharge_date);

                        // Show the printDischarge modal
                        $("#proceedDischarge").modal("show");

                        // Close the dischargeModal
                    ...
                    function print_discharge_modal() {
                        $("#patientNameInput").val(pat_name)
                        $("#docInput").val(pat_doc)
                        $("#admDate").val(pat_date_joined)
                        $("#dischargeDate").val(render_date)
                    }
                    ...
                    $("#viewInpatient").click(function() {
                        ...
                        if ($(".inpatient_table.selected").length > 0) {
                            ...
                            location.href = `/HIS-SWU/backend/admin/his_admin_view_single_patient.php?pat_id=${pat_id}&pat_number=${pat_number}`;
                        } else {
                    ...
                    $("#updateInpatient").click(function() {
                        ...
                        if ($(".inpatient_table.selected").length > 0) {
                            ...
                            location.href = `/HIS-SWU/backend/admin/his_admin_update_single_outpatient.php?pat_id=${pat_id}&pat_number=${pat_number}`;
                        }
                    });
                    ...
                    $("#toDischarge").click(function() {
                        $.ajax({
                            ...
                            dataType: 'json',
                            success: function(data) {
                                console.log(data); // Log the entire data object to the console for debugging

                                if (data.success) {
                                    $("#dischargeModal").modal("hide"); // Hide the discharge modal
                                    $("#proceedDischarge").modal("show"); // hide the new modal
                                } else {
