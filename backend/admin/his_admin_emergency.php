...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['deleteRecordId'])) {
    ...
    $adn = "UPDATE his_patients SET deleted = 1 where pat_id=?";
    ...
    if ($stmt) {
        ...
        // header("Location: " . 'http://localhost/SWUcopy/backend/admin/his_admin_outpatient_records.php');
    } else {
        $err = "Try Again Later";
    }
}
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-row required">
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <!-- You can also add a small text message to provide more information -->
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            /* 
                                                     ...
                                                     */
                                            $result = "SELECT count(*) FROM his_patients WHERE tagged_as_mgh =0 AND pat_type = 'Emergency' AND discharged = 0 ";
                                            ...
                                            /* 
                                                     * code for summing up number of pharmaceuticals,
                                                     */
                                            $result = "SELECT count(*) FROM his_patients WHERE tagged_as_mgh =1 AND pat_type = 'Emergency' AND discharged = 0";
                                            $stmt = $mysqli->prepare($result);
                                            $stmt->execute();
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('#addpatient_emergency').on('submit', function(e) {
                        ...
                        currentRequest = $.ajax({
                            url: '/HIS-SWU/backend/admin/case.php',
                            method: 'POST',
                            data: patientData,
                            dataType: 'json',
                ...
                $(document).ready(function() {
                    ...
                    $("#updateInpatient").click(function() {
                        ...
                        if ($(".inpatient_table.selected").length > 0) {
                            ...
                            location.href = `/HIS-SWU/backend/admin/his_admin_update_emergency.php?pat_id=${pat_id}&pat_number=${pat_number}`;
                        }
                    });
