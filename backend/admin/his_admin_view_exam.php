                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="3"> Items and Services </a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Description : <?php echo $row->exam_code;?></h2>
                                                    <hr>
                                                    <h4 class="text-danger">Code: <?php echo $row->exam_desc;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Category: <?php echo $row->exam_category;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Abbreviation : <?php echo $row->exam_abb;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Unit: <?php echo $row->exam_unit;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Big Unit : <?php echo $row->exam_big;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Conversion: <?php echo $row->exam_conv;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Barcode ID: <?php echo $row->exam_bar;?></h4>
