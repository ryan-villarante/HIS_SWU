                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Nursing Services</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Nursing Services</h4>
                                    <div class="mb-2">
                                        <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-toggle="true">Attending Physician</th>
                                                <th data-hide="phone">Room No.</th>
                                                <th data-hide="phone">Bed No. </th>
                                                <th data-hide="phone">Source of Admission</th>
                                                <th data-hide="phone">Admission Case Date</th>
                                                <th data-hide="phone">Transaction No.</th>
                                                <th data-hide="phone">Hospitalization Plan</th>
                                                <th data-hide="phone">Admission Case No.</th>
