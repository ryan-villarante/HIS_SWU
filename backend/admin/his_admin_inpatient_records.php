    ...
    <div id="wrapper">
        ...
        <div class="content-page-inpatient">
            <div class="content">
                                    ...
                                    <div class="row-inpatient">
                                        <div class="col-lg-9 my-1">
                                            ...
                                            */
                                                ...
                                                WHERE p.pat_type = 'InPatient' AND p.deleted = 0 AND discharged = 0  ";
                                                        // p.discharged != 0 
                                        ...
                                        <div class="col-lg-3 my-2 ">
                                            ...
                                            <div class="col-6">
                                                <div class="text-right">
                                                     ...
                                                     */
                                                    $result = "SELECT count(*) FROM his_patients WHERE tagged_as_mgh =0 AND discharged = 0 AND pat_type = 'InPatient' ";
                                                     ...
                                                     * code for summing up number of pharmaceuticals,
                                                     */
                                                    $result = "SELECT count(*) FROM his_patients WHERE tagged_as_mgh =1 AND discharged = 0 AND pat_type = 'InPatient' ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                    ...
                    $(document).ready(function() {
                        ...
                        $("#updateInpatient").click(function() {
                            ...
                            if ($(".inpatient_table.selected").length > 0) {
                                ...
                                location.href = `/HIS-SWU/backend/admin/his_admin_update_single_patient.php?pat_id=${pat_id}&pat_number=${pat_number}`;
                            }
                        });
                ...
                <script>
                    document.getElementById("printDischargeSlip").addEventListener("click", function(event) {
