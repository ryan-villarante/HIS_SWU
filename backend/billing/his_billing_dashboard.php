                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            /*code for summing up number of vendors whom supply eqipments, 
                                                     *pharms or any other equipments
                                                     */
                                            $result = "SELECT count(*) FROM his_ancillary WHERE deleted =1 ";
                                            $stmt = $mysqli->prepare($result);
                                            $stmt->execute();
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            /*code for summing up number of vendors whom supply eqipments, 
                                                     *pharms or any other equipments
                                                     */
                                            $result = "SELECT count(*) FROM his_ancillary WHERE paid = 0 ";
                                            $stmt = $mysqli->prepare($result);
                                            $stmt->execute();
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            /*code for summing up number of vendors whom supply eqipments, 
                                                     *pharms or any other equipments
                                                     */
                                            $result = "SELECT count(*) FROM his_ancillary WHERE paid = 1 ";
                                            $stmt = $mysqli->prepare($result);
                                            $stmt->execute();
                        ...
                        <div class="col-xl-12">
                            <div class="card-box">
                                <div class="form-group col-md-12 my-1">
                                    <input type="text" readonly name="" value="Cleared Patients" class="form-control" style="background-color:#800;color:white;text-align: center;">
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table id="patient-table" class="table table-borderless table-hover table-centered m-0" data-page-size="5">
                                        ...
                                        <tbody data-toggle="true" data-show="4">
                                            ...
                                            <?php
                                            $ret = "SELECT * FROM his_ancillary WHERE paid= 1  ";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row->render_pat_type; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->render_age; ?>Years
                                                    </td>
                                                    <td>
                                                        <?php echo $row->render_room_number; ?>
                                                    </td>

                                                    <td>₱
                                                        <?php echo $row->render_room_price ?>.00
                                                    </td>
                                                    <td>₱
                                                        <?php echo $row->render_pro_fee ?>.00
                                                    </td>
                                                    <td>
                                                        <?php echo $row->render_item_price ?>
                                                    <td>
                                                        <?php echo $row->render_payment ?>
                                                    </td>
