    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            <div class="content">
                ...
                $ret = "SELECT user_fname, user_lname FROM his_user WHERE user_dept = 'Cashier' AND  user_id = ?";
                ...
                if ($result->num_rows > 0) {
                    ...
                    $render = $row['user_fname'] . ' ' . $row['user_lname'] . '  '; // Concatenate first name and last name
                } else {
