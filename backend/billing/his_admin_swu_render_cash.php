...
if (isset($_POST['add_cash'])) {
    ...
    if ($cash_amount >= $cash_applied) {
        ...
        if ($stmt && $stmt_delete) {
            ...
            header("Location: http://localhost/HIS-SWU/backend/billing/his_doc_cash.php");
        } else {
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            <div class="content">
                ...
                $ret = "SELECT user_fname, user_lname FROM his_user WHERE user_dept = 'Billing' AND user_id = ?";
                ...
                if ($result->num_rows > 0) {
                    ...
                    $cashier = $row['user_fname'] . ' ' . $row['user_lname']; // Concatenate first name and last name
                } else {
                                ...
                                <div class="card-box">
                                    <form method="post" action="his_admin_swu_render_cash.php" id="cashForm">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-2 my-1">
                                                            ...
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text cash hehe">Items and Services</span>
                                                            </div>
                                                        ...
                                                        <div class="input-group mb-2 ">
                                                            ...
                                                            <input type="number" name="cash" class="form-control cash  " id="cash" onchange="calculateCharge()" value="0.00" style="background-color: #feffc878;font-weight:bolder;font-size:large; border:2px solid;">
                                                        </div>
                                                        <div class="input-group mb-2 " style="display: none;">
                                                            <div class="input-group-prepend">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="number" readonly name="AmountTendered" class="form-control cash " id="tendered" onkeyup="calculateCharge()" value="0.00">
                                                        </div>
                                                        <div class="input-group mb-2">
                                                            <div class="input-group-prepend">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control hehe" required="Required" id="exampleTextarea" name="cash_remark" rows="3" placeholder="Enter Remarks" value="Paid"></textarea>
                                                        </div>
                                        ...
                                        <div class="form-row  justify-content-end my-2">
                                            ...
                                            <a href="his_doc_cash.php" button type="button" class="btn btn-danger">Cancel</button></a>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" readonly name="" class="form-control input-sm" id="inputlg" value="0.00">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" readonly name="cash_cashier" class="form-control input-sm" id="inputlg" value="<?php echo $cashier ?>">
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a type="submit" name="" href="his_admin_swu_render_cash_print.php?render_id=<?php echo $render_id ?>" class="btn btn-primary" role="button" id="printButton">Print</a>
