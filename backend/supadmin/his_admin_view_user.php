                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <button type="button" class="	fa fa-plus lg-4 bi-plus btn btn-secondary btn-lg-2" data-toggle="modal" data-target="#myModal"> Add User </button>
                            ...
                            <form method="post" action="his_admin_view_user.php">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_supadmin_edit_user.php?user_number=<?php echo $row->user_number; ?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Update</a>
