                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="his_supadmin_account.php;">Super Admin</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-sm-center form-inline">
                                            ...
                                            <!-- <div class="form-group">
                                                    ...
                                                    <a href="his_admin_register_patient.php" style="position: absolute;margin-left: 85%;"><button type="button" class="btn btn-success">+ Add Super Admin</button></a>
                                                </div> -->
                                        </div>
                                    </div>
                                </div>
