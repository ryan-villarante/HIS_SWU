...
if (isset($_POST['update_profile'])) {
    ...
    $rc = $stmt->bind_param('ssssi', $sup_fname, $sup_lname, $sup_email, $sup_dpic, $sup_id);
    $stmt->execute();
    /*
...
if (isset($_POST['update_pwd'])) {
    $sup_id = $_SESSION['sup_id'];
    $sup_pwd = sha1(md5($_POST['sup_pwd'])); //double encrypt

    //sql to insert captured values
    $query = "UPDATE his_supadmin SET sup_pwd =? WHERE sup_id = ?";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('si', $sup_pwd, $sup_id);
    $stmt->execute();
    /*
     *Use Sweet Alerts Instead Of This Fucked Up Javascript Alerts
     *echo"<script>alert('Successfully Created Account Proceed To Log In ');</script>";
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ml-2"><?php echo $row->sup_fname; ?> <?php echo $row->sup_lname; ?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ml-2 "><?php echo $row->sup_email; ?></span></p>
                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control" name="sup_pwd" id="lastname" placeholder="Enter New Password">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
