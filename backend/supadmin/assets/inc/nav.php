...
?>
    <div class="navbar-custom">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <!-- item-->
                    <a href="his_supadmin_account.php" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
                    ...
                    <!-- item-->
                    <a href="his_supadmin_logout_partial.php" class="dropdown-item notify-item">
        ...
        <!-- LOGO -->
        <div class="logo-box">
            <a href="his_supadmin_dashboard.php" class="logo text-center">
                <span class="logo-lg">
                    <img src="assets/images/logos.png" alt="" height="78">
