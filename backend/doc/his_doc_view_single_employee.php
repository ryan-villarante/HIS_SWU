                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-3 font-50"><strong>Full Name :</strong> <span class="ml-2"><?php echo $row->doc_fname;?> <?php echo $row->doc_lname;?></span></p>
                                        <p class="text-muted mb-3 font-50"><strong>Category:</strong> <span class="ml-2"><?php echo $row->doc_cat;?></span></p>
                                        <p class="text-muted mb-3 font-50"><strong>Specialization :</strong> <span class="ml-2"><?php echo $row->doc_dept;?></span></p>
                                        <p class="text-muted mb-3 font-50"><strong>Employee Number :</strong> <span class="ml-2"><?php echo $row->doc_number;?></span></p>
                                        <p class="text-muted mb-3 font-50"><strong>Email :</strong> <span class="ml-2"><?php echo $row->doc_email;?></span></p>
