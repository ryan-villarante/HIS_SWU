	...
	include('assets/inc/config.php');
		if(isset($_POST['update_profile']))
		{
           ...
           // $doc_pwd=sha1(md5($_POST['doc_pwd']));
		    ...
		    move_uploaded_file($_FILES["user_dpic"]["tmp_name"],"assets/images/users/".$_FILES["doc_dpic"]["name"]);
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="user_fname"  class="form-control" id="firstname" placeholder="<?php echo $row->user_fname;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">Last Name</label>
                                                                <input type="text" name="user_lname" class="form-control" id="lastname" placeholder="<?php echo $row->user_lname;?>">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" name="user_email" class="form-control" id="useremail" placeholder="<?php echo $row->user_email;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="useremail">Profile Picture</label>
                                                                <input type="file" name="user_dpic" class="form-control btn btn-success" id="useremail" >
                                                            </div>
                                                        </div>
