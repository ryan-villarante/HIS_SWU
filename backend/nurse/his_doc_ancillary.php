                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        ?>
                                                            ...
                                                            <form method="post">
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-8 my-2">
                                                                        ...
                                                                        <select id="patientType" required="required" name="" class="form-control" style="background-color:#fff3f3 ;">
                                                                    ...
                                                                    <div class="form-group col-md-4 my-2">
                                                                        ...
                                                                        <input style="background-color: #fff3f3;" type="text" readonly name="case_status" class="form-control input-sm" id="inputlg" value="Active">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table id="patientTypeTable" class="table table-borderless table-hover mb-0" data-page-size="7">
                                                                    ...
                                                                    <tbody>
                                                                        <?php while ($row = $res->fetch_object()) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a style="background-color:#800;" href="his_admin_render.php?pat_id=<?php echo $row->pat_id; ?>&pat_number=<?php echo $row->pat_number; ?>" class="badge badge-success" style="background-color: #800;"><i class="mdi mdi-eye"></i> Select</a>
                                                                                </td>
                                                                            </tr>
                                                                        <?php } ?>
                                                                    </tbody>
