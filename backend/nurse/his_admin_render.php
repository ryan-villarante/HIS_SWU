...
if (isset($_POST['add_render'])) {
    ...
    if ($stmt) {
        ...
        header("Location: " . '/HIS-SWU/backend/nurse/his_doc_ancillary.php');
    } else {
...
<body>
    ...
    <div id="wrapper">
        ...
        <form method="post" action="his_admin_render.php" id="myForm">
            ...
            $ret = "SELECT user_fname, user_lname FROM his_user WHERE user_dept = 'Nurse' AND user_id = ?";
            ...
            if ($result->num_rows > 0) {
                ...
                $render = $row['user_fname'] . ' ' . $row['user_lname'] . '  ' . '- Nurse'; // Concatenate first name and last name
            } else {
            ...
            <input type="" class="form-control" value="<?php echo $render ?>">
