                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="his_doc_equipment.php"> Items and Services </a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-5">
                                            ...
                                            <div class="tab-content pt-0">
                                                ...
                                                <div class="tab-pane active show" id="product-1-item">
                                                    <img src="../admin/assets/images/1.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                                </div>
                                        ...
                                        <div class="col-xl-7">
                                            ...
                                            <div class="pl-xl-3 mt-3 mt-xl-0">
                                                <h2 class="mb-3">Description : <?php echo $row->exam_desc; ?></h2>
                                                <hr>
                                                <h4 class="text-secondary">Code: <?php echo $row->exam_code; ?></h4>
                                                <hr>
                                                <h4 class="text-secondary">Category: <?php echo $row->exam_category; ?></h4>
                                                <hr>
                                                <h4 class="text-secondary">Abbreviation : <?php echo $row->exam_abb; ?></h4>
                                                <hr>
                                                <h4 class="text-secondary">Barcode ID: <?php echo $row->exam_bar; ?></h4>
                                                <hr>
                                                <h4 class="text-secondary">Price: ₱ <?php echo $row->exam_price; ?>.00</h4>
