...
<body>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="aboutme">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <form method="post" action="his_doc_equipment.php">
                                                    ...
                                                    ?>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="his_doc_view_single_eqp.php?item_code=<?php echo $row->item_code; ?>" class="badge badge-success "><i class="far fa-eye "></i> View</a>
                                                ...
                                                ?>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="his_doc_view_exam.php?exam_code=<?php echo $row->exam_code; ?>" class="badge badge-success"><i class="far fa-eye "></i> View</a>
                                                                ...
                                                                <a href="his_doc_equipment.php?delete=<?php echo $row->exam_id; ?>" class="badge badge-danger"><i class=" mdi mdi-trash-can-outline "></i> Delete</a>
                                                            </td>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post">
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        <label for="inputPassword4" class="col-form-label">Item Category</label>
                                                                        <select id="inputState" name="pro_category" class="form-control">
                                                                            <option>None</option>
                                                                    ...
                                                                    <div class="form-group col-md-6" style="display: none;">
                                                                        <label for="inputEmail4" class="col-form-label">Barcode ID</label>
                                                                        <input type="text" name="pro_bar" value="<?php echo $pcode ?>" class="form-control" id="inputEmail4">
                                                                    </div>
                                ...
                                ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="his_doc_view_procedure.php?pro_code=<?php echo $row->pro_code; ?>" class="badge badge-success"><i class="far fa-eye "></i> View</a>
                                                ...
                                                <a href="his_doc_equipment.php?delete=<?php echo $row->pro_id; ?>" class="badge badge-danger"><i class=" mdi mdi-trash-can-outline "></i> Delete</a>
                                            </td>
    ...
    <script>
        function updateAbbreviation() {
            // Get the value from the "Item Description" input
            var itemDescriptionValue = document.getElementById("itemDescription").value;

            // Set the value of the "Abbreviation" input to the value of the "Item Description" input
            document.getElementById("itemAbbreviation").value = itemDescriptionValue;
        }
    </script>
