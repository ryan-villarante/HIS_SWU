                            ...
                            <div class="card-box">
                                    ...
                                    if (isset($_SESSION['netAmount'])) {
                                        ...
                                        echo '<div class="col-sm-10">
                                            <div class="float-right ml-5">
                                                <p><b>      ₱ ' . number_format($netAmount, 2) . '</b> <span class="float-right"></span></p>
                                            </div>
                                            <div class="float-left" style="margin-left: 310px;">
                                                <p><b>    Items and Services</b> <span class="float-right"></span></p>
                                            </div>'
                                            ;
                                ...
                                <div class="col-sm-10" style="margin-top: 100px;">
                                    <div class="float-left">
                                        <p><b>Rendered By:&nbsp;<?php echo $rendered_by ?></b> <span class="float-right"></span></p>
