                        ...
                        <div class="col-12">
                            ...
                            <div class="card-box">
                                ...
                                <div class="col-md-12 d-flex justify-content-start">
                                    ...
                                    <button type="button" class="fa fa-plus lg-4 bi-plus btn btn-lg-2 btn-secondary" style="background-color: #800;" data-toggle="modal" data-target="#myModal"> Direct Render</button>
                                                        ...
                                                        ?>
                                                            ...
                                                            <form method="post">
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-8 my-2">
                                                                        ...
                                                                        <select id="patientType" required="required" name="" class="form-control" style="background-color: #ffecec;">
                                                                    ...
                                                                    <div class="form-group col-md-4 my-2">
                                                                        ...
                                                                        <input style="background-color: #ffecec;" type="text" readonly name="case_status" class="form-control input-sm" id="inputlg" value="Active">
                                                            ...
                                                            <script>
                                                                $("#patientType").change(function() {
                                                                    ...
                                                                    currentRequest = $.ajax({
                                                                        url: 'http://localhost/HIS-SWU/backend/medtech/his_admin_patient_type.php',
                                                                        method: 'GET',
                                                                        data: {
                                                                            patientType: type,
                                                                        },
                                                                            ...
                                                                            $.each(data, function(index, item) {
                                                                                $("#patientTypeTable tbody").append(
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <a href="his_admin_render.php?pat_id=${item.pat_id}&pat_number=${item.pat_number}" class="badge badge-success" style="background-color: #800;"><i class="mdi mdi-eye"></i> Select</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    `
                                                                                )
                                                                    ...
                                                                    <tbody>
                                                                        <?php while ($row = $res->fetch_object()) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="his_admin_render.php?pat_id=<?php echo $row->pat_id; ?>&pat_number=<?php echo $row->pat_number; ?>" class="badge badge-success" style="background-color: #800;"><i class="mdi mdi-eye"></i> Select</a>
                                                                                </td>
                                                                            </tr>
                                                                        <?php } ?>
                                                                    </tbody>
                                            ...
                                            */
                                            ...
                                            ?>
                                                <tbody>
                                                    ...
                                                    <!-- <td>
                                                        <a href="#" style="background-color: #800;" class="badge badge-danger" data-toggle="modal" data-target="#deleteConfirmationModal" data-recordid="<?php echo $row->render_id; ?>">
