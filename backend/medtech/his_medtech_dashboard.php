...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="text-right" style="display: none;">
                            ...
                            /*code for summing up number of vendors whom supply eqipments, 
                                                     *pharms or any other equipments
                                                     */
                            $result = "SELECT count(*) FROM his_examinations WHERE exam_category ='Laboratory Examinations' ";
                            $stmt = $mysqli->prepare($result);
                            $stmt->execute();
                            ...
                            /*code for summing up number of vendors whom supply eqipments, 
                                                     *pharms or any other equipments
                                                     */
                            $result = "SELECT count(*) FROM his_examinations WHERE exam_category ='X-Ray' ";
                            $stmt = $mysqli->prepare($result);
                            $stmt->execute();
                            $stmt->bind_result($xray);
                            $stmt->fetch();
                            $stmt->close();
                            ?>
                            <?php
                            /*code for summing up number of vendors whom supply eqipments, 
                                                     *pharms or any other equipments
                                                     */
                            $result = "SELECT count(*) FROM his_examinations WHERE exam_category ='CT Scan' ";
                            $stmt = $mysqli->prepare($result);
                            $stmt->execute();
                            $stmt->bind_result($ctscan);
                            $stmt->fetch();
                            $stmt->close();
                            ?>
                            <?php
                            /*code for summing up number of vendors whom supply eqipments, 
                                                     *pharms or any other equipments
                                                     */
                            $result = "SELECT count(*) FROM his_examinations WHERE exam_category ='2D Echo' ";
                            $stmt = $mysqli->prepare($result);
                            $stmt->execute();
                            $stmt->bind_result($echo);
                            $stmt->fetch();
                            $stmt->close();
                            ?>
                            <?php
                            ...
                            $stmt = $mysqli->prepare($result);
                            $stmt->execute();
                            $stmt->bind_result($meds);
                            $stmt->fetch();
                            $stmt->close();
                            ?>


                            <h3 class="text-secondary mt-1"><span data-plugin="counterup" style="font-size: x-large;font-weight: bold;"><?php echo $lab; ?></span></h3>
                            <p class="text-muted mb-1 text-truncate" style="font-size: large;font-weight: bold;">Lab exam </p>
                            <h3 class="text-secondary mt-1"><span data-plugin="counterup" style="font-size: x-large;font-weight: bold;"><?php echo $xray; ?></span></h3>
                            <p class="text-muted mb-1 text-truncate" style="font-size: large;font-weight: bold;">XRAY </p>
                            <h3 class="text-secondary mt-1"><span data-plugin="counterup" style="font-size: x-large;font-weight: bold;"><?php echo $ctscan; ?></span></h3>
                            <p class="text-muted mb-1 text-truncate" style="font-size: large;font-weight: bold;">ct scan </p>
                            <h3 class="text-secondary mt-1"><span data-plugin="counterup" style="font-size: x-large;font-weight: bold;"><?php echo $echo; ?></span></h3>
                            <p class="text-muted mb-1 text-truncate" style="font-size: large;font-weight: bold;">2d echo </p>
                            <h3 class="text-secondary mt-1"><span data-plugin="counterup" style="font-size: x-large;font-weight: bold;"><?php echo $meds; ?></span></h3>
                            <p class="text-muted mb-1 text-truncate" style="font-size: large;font-weight: bold;">meds </p>
                        </div>
    ...
    <script>
        ...
        var pieChart2 = new Chart(items, {
            type: "bar",
            data: {
                labels: ["Laboratory Exam",
                    "Xray", "2D Echo", "CT Scan"
                ],
                datasets: [{
                    data: [lab, xray, echo, ctscan],
                    label: "Examinations",
                    backgroundColor: [
