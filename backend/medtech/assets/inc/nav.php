<div class="navbar-custom" style="background-color: #800;">
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        while ($row = $res->fetch_object()) {
            $result2 = "SELECT COUNT(*) as total FROM his_notify WHERE cleared = 0 AND no_dept = 'Laboratory Services'";
    ...
    <!-- LOGO -->
    <div class="logo-box">
        <a href="his_medtech_dashboard.php" class="logo text-center">
            <span class="logo-lg">
    ...
    <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
        <li>
            ...
            <span class="logo-lg-text-light" style="color: white;font-size:large;font-weight:bold">MEDTECH</span>
        </li>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                $res = $stmt->get_result();
                while ($row = $res->fetch_object()) {
                    $result2 = "SELECT * FROM his_notify WHERE cleared  = 0 AND no_dept = 'Laboratory Services'";
                    $stmt2 = $mysqli->prepare($result2);
                    $stmt2->execute();
                    $res2 = $stmt2->get_result();
                    while ($row2 = $res2->fetch_object()) {
