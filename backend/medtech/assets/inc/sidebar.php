    ...
    <div class="slimscroll-menu">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="his_medtech_dashboard.php">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="his_doc_guarantor.php">
                                ...
                                <span style="font-size: large;">HMO Guarantors </span>
                            </a>
                        </li>
                        <li>
            ...
            <li>
                <a href="his_doc_manage_user.php">
                    ...
                    <span style="font-size:large; font-weight:bold; font-weight:bold; font-family: Nunito,sans-serif; "> My Account </span>
                    <span class="menu-arrow"></span>
                </a>
                <ul class="nav-second-level" aria-expanded="false">
