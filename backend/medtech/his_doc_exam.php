...
<body>
    ...
    <div id="wrapper" class="nonPrintable">
                                                                    ...
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="input-group mb-2 my-2">
                                                                                ...
                                                                                <input type="text" name="wbc" class="form-control exam   " id="inputlg" value="" style="font-weight: bold;">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="seg" class="form-control exam  " id="inputlg" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="lym" class="form-control exam   " id="hosBill" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="mon" class="form-control exam " id="inputlg" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="eos" class="form-control exam  " id="inputlg" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="bas" class="form-control exam   " id="hosBill" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="rbc" class="form-control exam " id="inputlg" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="hgb" class="form-control exam  " id="inputlg" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="hct" class="form-control exam   " id="hosBill" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="mcv" class="form-control exam " id="inputlg" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="mch" class="form-control exam " id="inputlg" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="mchc" class="form-control exam " id="inputlg" value="">
                                                                            ...
                                                                            <div class="input-group mb-2 ">
                                                                                ...
                                                                                <input type="text" name="plt" class="form-control exam " id="inputlg" value="">
        ...
        <form method="post" action="his_doc_exam.php">
